...
### Generated Layer (`internal/repository/generated/`)
...
### Query Layer (`internal/repository/queries/`)
...
3. **Regenerate code**: Run `make generate` to update `internal/repository/generated/`
...
Your custom code in `internal/repository/`, `internal/service/`, and `internal/api/` remains intact!
