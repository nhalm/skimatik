...
func (cg *CodeGenerator) generateTableCode(table Table) (string, error) {
	...
	// Header
	fmt.Fprintf(&code, "// Code generated by skimatik %s. DO NOT EDIT.\n", cg.version)
	fmt.Fprintf(&code, "// Source: table %s\n\n", table.Name)
...
func (cg *CodeGenerator) GenerateSharedIDGenerators() error {
	...
	// Header
	fmt.Fprintf(&code, "// Code generated by skimatik %s. DO NOT EDIT.\n", cg.version)
	code.WriteString("// This file provides shared ID generator utilities for all repositories\n\n")

	// Package declaration
	fmt.Fprintf(&code, "package %s\n\n", cg.config.PackageName)

	// Execute template using template manager
	result, err := cg.templateMgr.ExecuteTemplate(TemplateIDGenerators, nil)
	if err != nil {
